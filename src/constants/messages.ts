export const USERS_MESSAGES = {
  ...
  //email
  EMAIL_ALREADY_EXISTS: 'Email này đã có người sử dụng',
  ...
  EMAIL_VERIFY_TOKEN_IS_INVALID: 'Email verify token is valid',
  ACCOUNT_HAS_BEEN_BANNED: 'Account has been banned',
  RESEND_VERIFY_EMAIL_SUCCESS: 'Resend verify email successs',
